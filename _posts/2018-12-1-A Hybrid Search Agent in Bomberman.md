...
description: We developed an AI agent that combined rule-based system and Monte Carlo Tree Search in a game environment similar to Bomberman. The highlight contribution of this project is the process of how we configure the algorithms to work in a resource-intensive environment.
